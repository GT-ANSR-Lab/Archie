...
CUBIC = System("CUBIC", cca, CUBIC_apply, objectives = [throughput, latency])


# SuggestedOrdering("CUBIC_th", throughput, CUBIC, 1)
# SuggestedOrdering("CUBIC_lat", latency, CUBIC, 1)